    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                // TODO: ao invés de utilizar o Toast, criar uma nova activity para mostrar as
                // informações do Role, talves com um botão "Confirmar presença".
                Toast.makeText(MainScreenActivity.this, "role=" + selectedRole.getID(), Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
